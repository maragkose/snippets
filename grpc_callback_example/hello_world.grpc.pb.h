 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    std::unique_ptr< ::grpc::ClientReaderWriterInterface< ::HW::HelloNote, ::HW::HelloNote>> Chat(::grpc::ClientContext* context) {
      return std::unique_ptr< ::grpc::ClientReaderWriterInterface< ::HW::HelloNote, ::HW::HelloNote>>(ChatRaw(context));
    }
    std::unique_ptr< ::grpc::ClientAsyncReaderWriterInterface< ::HW::HelloNote, ::HW::HelloNote>> AsyncChat(::grpc::ClientContext* context, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncReaderWriterInterface< ::HW::HelloNote, ::HW::HelloNote>>(AsyncChatRaw(context, cq, tag));
    }
  ...
  class Stub final : public StubInterface {
   public:
    ...
    std::unique_ptr<  ::grpc::ClientAsyncReaderWriter< ::HW::HelloNote, ::HW::HelloNote>> AsyncChat(::grpc::ClientContext* context, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncReaderWriter< ::HW::HelloNote, ::HW::HelloNote>>(AsyncChatRaw(context, cq, tag));
    }
  ...
  class Service : public ::grpc::Service {
   public:
    Service();
    virtual ~Service();
    virtual ::grpc::Status Chat(::grpc::ServerContext* context, ::grpc::ServerReaderWriter< ::HW::HelloNote, ::HW::HelloNote>* stream);
  };
  ...
  class WithAsyncMethod_Chat : public BaseClass {
   ...
   public:
    ...
    ::grpc::Status Chat(::grpc::ServerContext* /*context*/, ::grpc::ServerReaderWriter< ::HW::HelloNote, ::HW::HelloNote>* /*stream*/)  override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestChat(::grpc::ServerContext* context, ::grpc::ServerAsyncReaderWriter< ::HW::HelloNote, ::HW::HelloNote>* stream, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
