...
class HelloNote PROTOBUF_FINAL :
 ...
 public:
  ...
  inline HelloNote* New() const final {
    return CreateMaybeMessage<HelloNote>(nullptr);
  }

  HelloNote* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_hello_5fworld_2eproto);
    return ::descriptor_table_hello_5fworld_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline void HelloNote::set_message(const std::string& value) {
...
inline void HelloNote::set_message(std::string&& value) {
  
  message_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:HW.HelloNote.message)
}
inline void HelloNote::set_message(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  message_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:HW.HelloNote.message)
}
inline void HelloNote::set_message(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:HW.HelloNote.message)
}
...
inline std::string* HelloNote::unsafe_arena_release_message() {
  // @@protoc_insertion_point(field_unsafe_arena_release:HW.HelloNote.message)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return message_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void HelloNote::unsafe_arena_set_allocated_message(
    std::string* message) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (message != nullptr) {
  ...
  message_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      message, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:HW.HelloNote.message)
}
